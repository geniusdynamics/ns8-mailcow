...
1. Click on [Use this template](https://github.com/NethServer/ns8-mailcow/generate).
...
1. Rename some references inside the repo:
   ...
   git mv imageroot/systemd/user/mailcow.service imageroot/systemd/user/${modulename}.service &&
   git mv imageroot/systemd/user/mailcow-app.service imageroot/systemd/user/${modulename}-app.service && 
   git mv tests/mailcow.robot tests/${modulename}.robot &&
   sed -i "s/mailcow/${modulename}/g" $(find .github/ * -type f) &&
...
Instantiate the module with:
    ...
    add-module ghcr.io/nethserver/mailcow:latest 1

The output of the command will return the instance name.
Output example:

    {"module_id": "mailcow1", "image_name": "mailcow", "image_url": "ghcr.io/nethserver/mailcow:latest"}
...
Test the module using the `test-module.sh` script:
    ...
    ./test-module.sh <NODE_ADDR> ghcr.io/nethserver/mailcow:latest
